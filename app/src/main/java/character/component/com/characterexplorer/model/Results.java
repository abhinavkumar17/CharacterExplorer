...
public class Results {
    ...
    public Results(String id, String name, String description, Thumbnail thumbnail, String resourceURI, String modified, List<Urls> urls, Collection series, Collection stories, Collection events, Collection comics) {
        this.id = id;
        this.name = name;
